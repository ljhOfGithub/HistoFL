...
if args.task == 'task_1_tumor_vs_normal':
    ...
    # args.n_classes=3
    dataset = Generic_WSI_Survival_Dataset(csv_path = '/home/jupyter-ljh/data/mydata/tcga_brca_all_clean.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            # label_dict = {'subtype_1':0, 'subtype_2':1, 'subtype_3':2},
...
if __name__ == '__main__':
    ...
    for lf in label_fracs:
        split_dir = 'splits/'+ str(args.task) + '_bug_{}'.format(int(lf * 100))
